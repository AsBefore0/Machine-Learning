...
$$
P(E_{\text{new}}, E_{\text{old}}, T) = 
\begin{cases} 
1, & \text{if } E_{\text{new}} \leq E_{\text{old}} \\
\exp\left(\frac{-(E_{\text{new}} - E_{\text{old}})}{T}\right), & \text{if } E_{\text{new}} > E_{\text{old}}
\end{cases}
...
$$
x_{\text{new}} = x_{\text{old}} + \sigma \cdot \mathcal{N}(0, 1)
...
$$
x_{\text{new}} = x_{\text{old}} + \gamma \cdot \text{Cauchy}(0, 1)
